...
public class XlsxReader {
    ...
    public static <T> XMLReader fetchSheetParser(StylesTable stylesTable, SharedStringsTable strings, List<T> rows, Class<T> clazz, int headerRowIndex) throws SAXException {
    ...
    public static class SheetHandler<T> extends DefaultHandler {
        ...
        private SheetHandler(StylesTable stylesTable, SharedStringsTable sharedStringsTable, List<T> rows, Class<T> clazz, int headerRowIndex) {
